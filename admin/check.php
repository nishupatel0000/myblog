        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query = "select  article.*,category.category_name  from article,category where article.category_id=category.category_id AND status='1'";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="edite.php?id=<?php echo $row['article_id']; ?>"><button class="btn btn-success">Edit</button></a>
